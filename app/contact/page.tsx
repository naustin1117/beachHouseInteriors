          ...
          >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                <div className="space-y-8">
                  <div className="flex items-start">
                    <svg
                      className="w-6 h-6 text-accent-600 mr-4 flex-shrink-0 mt-1"
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                    >
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <a href="tel:+15551234567" className="text-gray-600 hover:text-accent-600 transition-colors">
                        (555) 123-4567
                      </a>
                    </div>
                  </div>
                ...
                <div className="space-y-8">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <a href="mailto:hello@luxeinteriors.com" className="text-gray-600 hover:text-accent-600 transition-colors block">
                        hello@luxeinteriors.com
                      </a>
                      <a href="mailto:careers@luxeinteriors.com" className="text-gray-600 hover:text-accent-600 transition-colors block">
                        careers@luxeinteriors.com
                      </a>
                    </div>
                  </div>
            ...
            <motion.div variants={fadeInUp} className="text-center">
              ...
              <div className="flex justify-center space-x-4">
                <a
                  href="#"
                  className="w-12 h-12 bg-gray-100 hover:bg-accent-600 text-gray-700 hover:text-white rounded-full flex items-center justify-center transition-colors"
                >
